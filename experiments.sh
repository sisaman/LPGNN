...
### Flickr
python train.py -t node -d flickr   -m raw        -e 0      -r 10 --learning-rate 0.001 --weight-decay 0.0001 --dropout 0
python train.py -t node -d flickr   -m lm pm pgc  -e 1 5 9  -r 10 --learning-rate 0.001 --weight-decay 0.0001 --dropout 0
### Twitch
...
### Flickr
python train.py -t link -d flickr   -m raw        -e 0      -r 10 --learning-rate 0.001 --weight-decay 0.001
python train.py -t link -d flickr   -m lm pm pgc  -e 1 5 9  -r 10 --learning-rate 0.001 --weight-decay 0.001
### Twitch
